...
class EmbassiesMemStore: EmbassiesStoreProtocol {
    func fetchAllEmbassies(completion: @escaping EmbassiesStoreFetchAllEmbassiesCompletionHandler) {
        ...
        let embassyModel = EmbassyModel.init(idUrl: "123", typeUrl: "12312", title: "Embajada de mis padres", address: address, location: location)
        ...
        let embassyModel2 = EmbassyModel.init(idUrl: "123", typeUrl: "12312", title: "Consulado de mi casa", address: address2, location: location2)
